...
To demonstrate autoStreamTree, we employed existing SNP data for Speckled Dace (*Rhinichthys osculus*)[@Mussmann2018]. Data represent 5,742 SNPs from 762 individuals across 78 localities in the Colorado River ecosystem, after removing those with >=50% missing data or minor allele frequency (MAF) < 0.1.
